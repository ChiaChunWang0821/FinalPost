...
遊戲系統分為Android行動裝置端及Ardroid端: Android中主要含網路連線及影像處理之功能，利用網路連線與伺服器端開啟網路通道，影像處理則透過演算法計算改變原始影像；Arduino連接肌肉感測器，來獲取肌肉數據並以傅立葉轉換分析。Android與Arduino則是透過藍芽模組串連之，完成整個遊戲系統。
\center
